...
namespace DNPrinter
{
    ...
    /// <summary>
    /// Allows us to perform a network drive action as the specified user. Many OS operations require user authentication
    /// to perform them over a network and this allows us to use common OS actions as the currently logged in user.
    /// </summary>
